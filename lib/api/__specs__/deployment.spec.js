...
describe('api/deployment', () => {
  describe('#find', () => {
    it('finds a deployment', () => {
      const deployment = generateDeployment({ id: 'tassadar-123' })
  ...
  describe('#create', () => {
    ...
    describe('when optional params are not provided', () => {
      it('creates a deployment', () => {
        ...
        const deployment = generateDeployment({ releaseId, environmentId, comments })
    ...
    describe('when formValues are provided', () => {
      it('creates a deployment', () => {
        ...
        const deployment = generateDeployment({ releaseId, environmentId, comments, formValues })
        sandbox.stub(client, 'post').callsFake(() => BPromise.resolve(deployment))
    ...
    describe('when machineIds are provided', () => {
      it('creates a deployment', () => {
        ...
        const deployment = generateDeployment({ releaseId, environmentId, comments, specificMachineIds: machineIds })
        sandbox.stub(client, 'post').callsFake(() => BPromise.resolve(deployment))
